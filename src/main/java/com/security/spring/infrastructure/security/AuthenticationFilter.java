...
public class AuthenticationFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (authorization != null && authorization.toString().indexOf("Basic") != -1) {
			...
			username = Optional.fromNullable(Base64EncodeDecodeUtility.decode(base64Credentials)[0]);
			// credentials = username:password
			password = Optional.fromNullable(Base64EncodeDecodeUtility.decode(base64Credentials)[1]);
		}
